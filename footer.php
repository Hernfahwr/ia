    ...
    <div class="row footer-widgets">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="footer-widget contact-widget">
          <h4>
            <img src="assets/img/logo-default.png" class="img-responsive" alt="Footer Logo" />
          </h4>
          <p>
...
<div class="copyright-section">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <p>
          Copyright &copy; 2016 ConBiz - Designed & Developed by 
          <a href="#">
          GrayGrids
          </a>
        </p>
...
<!-- Start Loader -->
<div id="loader"><div class="square-spin"><div></div></div></div>