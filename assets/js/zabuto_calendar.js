...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $prevMonthNavIcon = $('<span><i class="fa fa-lg fa-chevron-circle-left" aria-hidden="true"></i></span>');
            var $nextMonthNavIcon = $('<span><i class="fa fa-lg fa-chevron-circle-right" aria-hidden="true"></i></span>');
